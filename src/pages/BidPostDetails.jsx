        ...
        <div className="grid grid-cols-1 md:grid-cols-12">
            <div className="grid col-span-3 mt-4">
                <div className="flex flex-col items-center">
                    <h1 className="text-center mb-3 text-xl font-semibold">You can find us on</h1>
                    <button className="btn btn-primary mb-2 w-1/2">Facebook</button>
                    <button className="btn btn-secondary mb-2 w-1/2">Instagram</button>
                    <button className="btn btn-warning mb-2 w-1/2">Youtube</button>
                </div>
            </div>
            <div className="grid col-span-6">
                <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
                    <div className="flex space-x-4">
                        <img alt="" src={seller.photo} className="object-cover w-12 h-12 rounded-full shadow dark:bg-gray-500" />
                        <div className="flex flex-col space-y-1">
                            <a rel="noopener noreferrer" href="#" className="text-sm font-semibold">{seller?.name}</a>
                    ...
                    <div>
                        ...
                        <div className="flex justify-between">
                            ...
                            <h3 className="text-xl text-orange-300">Bid Start from: $<span className="text-purple-400 font-bold">{price}</span></h3>
                        </div>
                        <div className="flex justify-between">
                            <p>Selling Reason: {selling_reason}</p>
                            <p>Purchase Date: <span className="text-red-500">{new Date(purchase_date).toLocaleDateString()}</span></p>
                        </div>
                        <div className="flex justify-between">
